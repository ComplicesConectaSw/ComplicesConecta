...
drop trigger if exists "update_chat_rooms_timestamp" on "public"."chat_rooms";
...
drop trigger if exists "tr_couple_profile_reports_updated_at" on "public"."couple_profile_reports";

drop trigger if exists "gallery_permissions_updated_at" on "public"."gallery_permissions";

drop trigger if exists "update_invitation_statistics_updated_at" on "public"."invitation_statistics";

drop trigger if exists "invitation_templates_updated_at" on "public"."invitation_templates";
...
drop trigger if exists "trigger_update_referral_statistics_updated_at" on "public"."referral_statistics";

drop trigger if exists "sync_reports_content_type_trigger" on "public"."reports";

drop trigger if exists "tr_reports_updated_at" on "public"."reports";

drop trigger if exists "staking_records_updated_at" on "public"."staking_records";
...
drop trigger if exists "two_factor_auth_updated_at" on "public"."two_factor_auth";

drop trigger if exists "trigger_update_user_referral_balances_updated_at" on "public"."user_referral_balances";

drop trigger if exists "update_couple_profiles_updated_at" on "public"."couple_profiles";
...
drop policy "Room admins can add members" on "public"."chat_members";

drop policy "Users can view members of their rooms" on "public"."chat_members";

drop policy "Users can delete their own messages" on "public"."chat_messages";

drop policy "Users can send messages to their rooms" on "public"."chat_messages";

drop policy "Users can update their own messages" on "public"."chat_messages";

drop policy "Users can view messages in their rooms" on "public"."chat_messages";

drop policy "Room creators can update their rooms" on "public"."chat_rooms";

drop policy "Users can create chat rooms" on "public"."chat_rooms";

drop policy "Users can view their chat rooms" on "public"."chat_rooms";
...
drop policy "Gallery owners can manage permissions" on "public"."gallery_permissions";

drop policy "Users can view own gallery permissions" on "public"."gallery_permissions";

drop policy "Users can view own statistics" on "public"."invitation_statistics";

drop policy "Admins can create invitation templates" on "public"."invitation_templates";

drop policy "Admins can delete invitation templates" on "public"."invitation_templates";

drop policy "Admins can update invitation templates" on "public"."invitation_templates";

drop policy "Anyone can view active invitation templates" on "public"."invitation_templates";

drop policy "Anyone can view active templates" on "public"."invitation_templates";
...
drop policy "Users can insert own statistics" on "public"."referral_statistics";

drop policy "Users can update own statistics" on "public"."referral_statistics";

drop policy "Users can view own statistics" on "public"."referral_statistics";

drop policy "Users can view their own statistics" on "public"."referral_statistics";

drop policy "Users can insert own transactions" on "public"."referral_transactions";

drop policy "Users can view own transactions" on "public"."referral_transactions";

drop policy "Users can view their own transactions" on "public"."referral_transactions";

drop policy "Admins can manage security events" on "public"."security_events";

drop policy "Users can create their own staking records" on "public"."staking_records";

drop policy "Users can update their own staking records" on "public"."staking_records";

drop policy "Users can view their own staking records" on "public"."staking_records";
...
drop policy "Users can update their own stories" on "public"."stories";

drop policy "Users can view public stories" on "public"."stories";

drop policy "Users can view their own stories" on "public"."stories";

drop policy "Anyone can view story comments" on "public"."story_comments";

drop policy "Users can create their own comments" on "public"."story_comments";

drop policy "Users can delete their own comments" on "public"."story_comments";

drop policy "Users can update their own comments" on "public"."story_comments";

drop policy "Anyone can view story likes" on "public"."story_likes";

drop policy "Users can create their own likes" on "public"."story_likes";

drop policy "Users can delete their own likes" on "public"."story_likes";

drop policy "Users can create their own shares" on "public"."story_shares";

drop policy "Users can view story shares" on "public"."story_shares";

drop policy "Anyone can view token analytics" on "public"."token_analytics";

drop policy "Users can create their own token transactions" on "public"."token_transactions";

drop policy "Users can view their own token transactions" on "public"."token_transactions";

drop policy "Users can create their own 2FA settings" on "public"."two_factor_auth";

drop policy "Users can delete their own 2FA settings" on "public"."two_factor_auth";

drop policy "Users can update their own 2FA settings" on "public"."two_factor_auth";

drop policy "Users can view their own 2FA settings" on "public"."two_factor_auth";

drop policy "Users can insert own referral balance" on "public"."user_referral_balances";

drop policy "Users can update own referral balance" on "public"."user_referral_balances";

drop policy "Users can update their own referral balance" on "public"."user_referral_balances";

drop policy "Users can view own referral balance" on "public"."user_referral_balances";

drop policy "Users can view their own referral balance" on "public"."user_referral_balances";

drop policy "Users can update own token balances" on "public"."user_token_balances";

drop policy "Users can view own token balances" on "public"."user_token_balances";
...
revoke delete on table "public"."chat_members" from "anon";

revoke insert on table "public"."chat_members" from "anon";

revoke references on table "public"."chat_members" from "anon";

revoke select on table "public"."chat_members" from "anon";

revoke trigger on table "public"."chat_members" from "anon";

revoke truncate on table "public"."chat_members" from "anon";

revoke update on table "public"."chat_members" from "anon";

revoke delete on table "public"."chat_members" from "authenticated";

revoke insert on table "public"."chat_members" from "authenticated";

revoke references on table "public"."chat_members" from "authenticated";

revoke select on table "public"."chat_members" from "authenticated";

revoke trigger on table "public"."chat_members" from "authenticated";

revoke truncate on table "public"."chat_members" from "authenticated";

revoke update on table "public"."chat_members" from "authenticated";

revoke delete on table "public"."chat_members" from "service_role";

revoke insert on table "public"."chat_members" from "service_role";

revoke references on table "public"."chat_members" from "service_role";

revoke select on table "public"."chat_members" from "service_role";

revoke trigger on table "public"."chat_members" from "service_role";

revoke truncate on table "public"."chat_members" from "service_role";

revoke update on table "public"."chat_members" from "service_role";
...
revoke delete on table "public"."couple_profile_likes" from "anon";

revoke insert on table "public"."couple_profile_likes" from "anon";

revoke references on table "public"."couple_profile_likes" from "anon";

revoke select on table "public"."couple_profile_likes" from "anon";

revoke trigger on table "public"."couple_profile_likes" from "anon";

revoke truncate on table "public"."couple_profile_likes" from "anon";

revoke update on table "public"."couple_profile_likes" from "anon";

revoke delete on table "public"."couple_profile_likes" from "authenticated";

revoke insert on table "public"."couple_profile_likes" from "authenticated";

revoke references on table "public"."couple_profile_likes" from "authenticated";

revoke select on table "public"."couple_profile_likes" from "authenticated";

revoke trigger on table "public"."couple_profile_likes" from "authenticated";

revoke truncate on table "public"."couple_profile_likes" from "authenticated";

revoke update on table "public"."couple_profile_likes" from "authenticated";

revoke delete on table "public"."couple_profile_likes" from "service_role";

revoke insert on table "public"."couple_profile_likes" from "service_role";

revoke references on table "public"."couple_profile_likes" from "service_role";

revoke select on table "public"."couple_profile_likes" from "service_role";

revoke trigger on table "public"."couple_profile_likes" from "service_role";

revoke truncate on table "public"."couple_profile_likes" from "service_role";

revoke update on table "public"."couple_profile_likes" from "service_role";

revoke delete on table "public"."couple_profile_reports" from "anon";

revoke insert on table "public"."couple_profile_reports" from "anon";

revoke references on table "public"."couple_profile_reports" from "anon";

revoke select on table "public"."couple_profile_reports" from "anon";

revoke trigger on table "public"."couple_profile_reports" from "anon";

revoke truncate on table "public"."couple_profile_reports" from "anon";

revoke update on table "public"."couple_profile_reports" from "anon";

revoke delete on table "public"."couple_profile_reports" from "authenticated";

revoke insert on table "public"."couple_profile_reports" from "authenticated";

revoke references on table "public"."couple_profile_reports" from "authenticated";

revoke select on table "public"."couple_profile_reports" from "authenticated";

revoke trigger on table "public"."couple_profile_reports" from "authenticated";

revoke truncate on table "public"."couple_profile_reports" from "authenticated";

revoke update on table "public"."couple_profile_reports" from "authenticated";

revoke delete on table "public"."couple_profile_reports" from "service_role";

revoke insert on table "public"."couple_profile_reports" from "service_role";

revoke references on table "public"."couple_profile_reports" from "service_role";

revoke select on table "public"."couple_profile_reports" from "service_role";

revoke trigger on table "public"."couple_profile_reports" from "service_role";

revoke truncate on table "public"."couple_profile_reports" from "service_role";

revoke update on table "public"."couple_profile_reports" from "service_role";

revoke delete on table "public"."couple_profile_views" from "anon";

revoke insert on table "public"."couple_profile_views" from "anon";

revoke references on table "public"."couple_profile_views" from "anon";

revoke select on table "public"."couple_profile_views" from "anon";

revoke trigger on table "public"."couple_profile_views" from "anon";

revoke truncate on table "public"."couple_profile_views" from "anon";

revoke update on table "public"."couple_profile_views" from "anon";

revoke delete on table "public"."couple_profile_views" from "authenticated";

revoke insert on table "public"."couple_profile_views" from "authenticated";

revoke references on table "public"."couple_profile_views" from "authenticated";

revoke select on table "public"."couple_profile_views" from "authenticated";

revoke trigger on table "public"."couple_profile_views" from "authenticated";

revoke truncate on table "public"."couple_profile_views" from "authenticated";

revoke update on table "public"."couple_profile_views" from "authenticated";

revoke delete on table "public"."couple_profile_views" from "service_role";

revoke insert on table "public"."couple_profile_views" from "service_role";

revoke references on table "public"."couple_profile_views" from "service_role";

revoke select on table "public"."couple_profile_views" from "service_role";

revoke trigger on table "public"."couple_profile_views" from "service_role";

revoke truncate on table "public"."couple_profile_views" from "service_role";

revoke update on table "public"."couple_profile_views" from "service_role";
...
revoke delete on table "public"."gallery_permissions" from "anon";

revoke insert on table "public"."gallery_permissions" from "anon";

revoke references on table "public"."gallery_permissions" from "anon";

revoke select on table "public"."gallery_permissions" from "anon";

revoke trigger on table "public"."gallery_permissions" from "anon";

revoke truncate on table "public"."gallery_permissions" from "anon";

revoke update on table "public"."gallery_permissions" from "anon";

revoke delete on table "public"."gallery_permissions" from "authenticated";

revoke insert on table "public"."gallery_permissions" from "authenticated";

revoke references on table "public"."gallery_permissions" from "authenticated";

revoke select on table "public"."gallery_permissions" from "authenticated";

revoke trigger on table "public"."gallery_permissions" from "authenticated";

revoke truncate on table "public"."gallery_permissions" from "authenticated";

revoke update on table "public"."gallery_permissions" from "authenticated";

revoke delete on table "public"."gallery_permissions" from "service_role";

revoke insert on table "public"."gallery_permissions" from "service_role";

revoke references on table "public"."gallery_permissions" from "service_role";

revoke select on table "public"."gallery_permissions" from "service_role";

revoke trigger on table "public"."gallery_permissions" from "service_role";

revoke truncate on table "public"."gallery_permissions" from "service_role";

revoke update on table "public"."gallery_permissions" from "service_role";

revoke delete on table "public"."invitation_statistics" from "anon";

revoke insert on table "public"."invitation_statistics" from "anon";

revoke references on table "public"."invitation_statistics" from "anon";

revoke select on table "public"."invitation_statistics" from "anon";

revoke trigger on table "public"."invitation_statistics" from "anon";

revoke truncate on table "public"."invitation_statistics" from "anon";

revoke update on table "public"."invitation_statistics" from "anon";

revoke delete on table "public"."invitation_statistics" from "authenticated";

revoke insert on table "public"."invitation_statistics" from "authenticated";

revoke references on table "public"."invitation_statistics" from "authenticated";

revoke select on table "public"."invitation_statistics" from "authenticated";

revoke trigger on table "public"."invitation_statistics" from "authenticated";

revoke truncate on table "public"."invitation_statistics" from "authenticated";

revoke update on table "public"."invitation_statistics" from "authenticated";

revoke delete on table "public"."invitation_statistics" from "service_role";

revoke insert on table "public"."invitation_statistics" from "service_role";

revoke references on table "public"."invitation_statistics" from "service_role";

revoke select on table "public"."invitation_statistics" from "service_role";

revoke trigger on table "public"."invitation_statistics" from "service_role";

revoke truncate on table "public"."invitation_statistics" from "service_role";

revoke update on table "public"."invitation_statistics" from "service_role";

revoke delete on table "public"."invitation_templates" from "anon";

revoke insert on table "public"."invitation_templates" from "anon";

revoke references on table "public"."invitation_templates" from "anon";

revoke select on table "public"."invitation_templates" from "anon";

revoke trigger on table "public"."invitation_templates" from "anon";

revoke truncate on table "public"."invitation_templates" from "anon";

revoke update on table "public"."invitation_templates" from "anon";

revoke delete on table "public"."invitation_templates" from "authenticated";

revoke insert on table "public"."invitation_templates" from "authenticated";

revoke references on table "public"."invitation_templates" from "authenticated";

revoke select on table "public"."invitation_templates" from "authenticated";

revoke trigger on table "public"."invitation_templates" from "authenticated";

revoke truncate on table "public"."invitation_templates" from "authenticated";

revoke update on table "public"."invitation_templates" from "authenticated";

revoke delete on table "public"."invitation_templates" from "service_role";

revoke insert on table "public"."invitation_templates" from "service_role";

revoke references on table "public"."invitation_templates" from "service_role";

revoke select on table "public"."invitation_templates" from "service_role";

revoke trigger on table "public"."invitation_templates" from "service_role";

revoke truncate on table "public"."invitation_templates" from "service_role";

revoke update on table "public"."invitation_templates" from "service_role";
...
revoke delete on table "public"."referral_statistics" from "anon";

revoke insert on table "public"."referral_statistics" from "anon";

revoke references on table "public"."referral_statistics" from "anon";

revoke select on table "public"."referral_statistics" from "anon";

revoke trigger on table "public"."referral_statistics" from "anon";

revoke truncate on table "public"."referral_statistics" from "anon";

revoke update on table "public"."referral_statistics" from "anon";

revoke delete on table "public"."referral_statistics" from "authenticated";

revoke insert on table "public"."referral_statistics" from "authenticated";

revoke references on table "public"."referral_statistics" from "authenticated";

revoke select on table "public"."referral_statistics" from "authenticated";

revoke trigger on table "public"."referral_statistics" from "authenticated";

revoke truncate on table "public"."referral_statistics" from "authenticated";

revoke update on table "public"."referral_statistics" from "authenticated";

revoke delete on table "public"."referral_statistics" from "service_role";

revoke insert on table "public"."referral_statistics" from "service_role";

revoke references on table "public"."referral_statistics" from "service_role";

revoke select on table "public"."referral_statistics" from "service_role";

revoke trigger on table "public"."referral_statistics" from "service_role";

revoke truncate on table "public"."referral_statistics" from "service_role";

revoke update on table "public"."referral_statistics" from "service_role";
...
revoke delete on table "public"."staking_records" from "anon";

revoke insert on table "public"."staking_records" from "anon";

revoke references on table "public"."staking_records" from "anon";

revoke select on table "public"."staking_records" from "anon";

revoke trigger on table "public"."staking_records" from "anon";

revoke truncate on table "public"."staking_records" from "anon";

revoke update on table "public"."staking_records" from "anon";

revoke delete on table "public"."staking_records" from "authenticated";

revoke insert on table "public"."staking_records" from "authenticated";

revoke references on table "public"."staking_records" from "authenticated";

revoke select on table "public"."staking_records" from "authenticated";

revoke trigger on table "public"."staking_records" from "authenticated";

revoke truncate on table "public"."staking_records" from "authenticated";

revoke update on table "public"."staking_records" from "authenticated";

revoke delete on table "public"."staking_records" from "service_role";

revoke insert on table "public"."staking_records" from "service_role";

revoke references on table "public"."staking_records" from "service_role";

revoke select on table "public"."staking_records" from "service_role";

revoke trigger on table "public"."staking_records" from "service_role";

revoke truncate on table "public"."staking_records" from "service_role";

revoke update on table "public"."staking_records" from "service_role";
...
revoke delete on table "public"."story_comments" from "anon";

revoke insert on table "public"."story_comments" from "anon";

revoke references on table "public"."story_comments" from "anon";

revoke select on table "public"."story_comments" from "anon";

revoke trigger on table "public"."story_comments" from "anon";

revoke truncate on table "public"."story_comments" from "anon";

revoke update on table "public"."story_comments" from "anon";

revoke delete on table "public"."story_comments" from "authenticated";

revoke insert on table "public"."story_comments" from "authenticated";

revoke references on table "public"."story_comments" from "authenticated";

revoke select on table "public"."story_comments" from "authenticated";

revoke trigger on table "public"."story_comments" from "authenticated";

revoke truncate on table "public"."story_comments" from "authenticated";

revoke update on table "public"."story_comments" from "authenticated";

revoke delete on table "public"."story_comments" from "service_role";

revoke insert on table "public"."story_comments" from "service_role";

revoke references on table "public"."story_comments" from "service_role";

revoke select on table "public"."story_comments" from "service_role";

revoke trigger on table "public"."story_comments" from "service_role";

revoke truncate on table "public"."story_comments" from "service_role";

revoke update on table "public"."story_comments" from "service_role";

revoke delete on table "public"."story_likes" from "anon";

revoke insert on table "public"."story_likes" from "anon";

revoke references on table "public"."story_likes" from "anon";

revoke select on table "public"."story_likes" from "anon";

revoke trigger on table "public"."story_likes" from "anon";

revoke truncate on table "public"."story_likes" from "anon";

revoke update on table "public"."story_likes" from "anon";

revoke delete on table "public"."story_likes" from "authenticated";

revoke insert on table "public"."story_likes" from "authenticated";

revoke references on table "public"."story_likes" from "authenticated";

revoke select on table "public"."story_likes" from "authenticated";

revoke trigger on table "public"."story_likes" from "authenticated";

revoke truncate on table "public"."story_likes" from "authenticated";

revoke update on table "public"."story_likes" from "authenticated";

revoke delete on table "public"."story_likes" from "service_role";

revoke insert on table "public"."story_likes" from "service_role";

revoke references on table "public"."story_likes" from "service_role";

revoke select on table "public"."story_likes" from "service_role";

revoke trigger on table "public"."story_likes" from "service_role";

revoke truncate on table "public"."story_likes" from "service_role";

revoke update on table "public"."story_likes" from "service_role";

revoke delete on table "public"."story_shares" from "anon";

revoke insert on table "public"."story_shares" from "anon";

revoke references on table "public"."story_shares" from "anon";

revoke select on table "public"."story_shares" from "anon";

revoke trigger on table "public"."story_shares" from "anon";

revoke truncate on table "public"."story_shares" from "anon";

revoke update on table "public"."story_shares" from "anon";

revoke delete on table "public"."story_shares" from "authenticated";

revoke insert on table "public"."story_shares" from "authenticated";

revoke references on table "public"."story_shares" from "authenticated";

revoke select on table "public"."story_shares" from "authenticated";

revoke trigger on table "public"."story_shares" from "authenticated";

revoke truncate on table "public"."story_shares" from "authenticated";

revoke update on table "public"."story_shares" from "authenticated";

revoke delete on table "public"."story_shares" from "service_role";

revoke insert on table "public"."story_shares" from "service_role";

revoke references on table "public"."story_shares" from "service_role";

revoke select on table "public"."story_shares" from "service_role";

revoke trigger on table "public"."story_shares" from "service_role";

revoke truncate on table "public"."story_shares" from "service_role";

revoke update on table "public"."story_shares" from "service_role";

revoke delete on table "public"."token_analytics" from "anon";

revoke insert on table "public"."token_analytics" from "anon";

revoke references on table "public"."token_analytics" from "anon";

revoke select on table "public"."token_analytics" from "anon";

revoke trigger on table "public"."token_analytics" from "anon";

revoke truncate on table "public"."token_analytics" from "anon";

revoke update on table "public"."token_analytics" from "anon";

revoke delete on table "public"."token_analytics" from "authenticated";

revoke insert on table "public"."token_analytics" from "authenticated";

revoke references on table "public"."token_analytics" from "authenticated";

revoke select on table "public"."token_analytics" from "authenticated";

revoke trigger on table "public"."token_analytics" from "authenticated";

revoke truncate on table "public"."token_analytics" from "authenticated";

revoke update on table "public"."token_analytics" from "authenticated";

revoke delete on table "public"."token_analytics" from "service_role";

revoke insert on table "public"."token_analytics" from "service_role";

revoke references on table "public"."token_analytics" from "service_role";

revoke select on table "public"."token_analytics" from "service_role";

revoke trigger on table "public"."token_analytics" from "service_role";

revoke truncate on table "public"."token_analytics" from "service_role";

revoke update on table "public"."token_analytics" from "service_role";
...
revoke delete on table "public"."two_factor_auth" from "anon";

revoke insert on table "public"."two_factor_auth" from "anon";

revoke references on table "public"."two_factor_auth" from "anon";

revoke select on table "public"."two_factor_auth" from "anon";

revoke trigger on table "public"."two_factor_auth" from "anon";

revoke truncate on table "public"."two_factor_auth" from "anon";

revoke update on table "public"."two_factor_auth" from "anon";

revoke delete on table "public"."two_factor_auth" from "authenticated";

revoke insert on table "public"."two_factor_auth" from "authenticated";

revoke references on table "public"."two_factor_auth" from "authenticated";

revoke select on table "public"."two_factor_auth" from "authenticated";

revoke trigger on table "public"."two_factor_auth" from "authenticated";

revoke truncate on table "public"."two_factor_auth" from "authenticated";

revoke update on table "public"."two_factor_auth" from "authenticated";

revoke delete on table "public"."two_factor_auth" from "service_role";

revoke insert on table "public"."two_factor_auth" from "service_role";

revoke references on table "public"."two_factor_auth" from "service_role";

revoke select on table "public"."two_factor_auth" from "service_role";

revoke trigger on table "public"."two_factor_auth" from "service_role";

revoke truncate on table "public"."two_factor_auth" from "service_role";

revoke update on table "public"."two_factor_auth" from "service_role";

revoke delete on table "public"."user_referral_balances" from "anon";

revoke insert on table "public"."user_referral_balances" from "anon";

revoke references on table "public"."user_referral_balances" from "anon";

revoke select on table "public"."user_referral_balances" from "anon";

revoke trigger on table "public"."user_referral_balances" from "anon";

revoke truncate on table "public"."user_referral_balances" from "anon";

revoke update on table "public"."user_referral_balances" from "anon";

revoke delete on table "public"."user_referral_balances" from "authenticated";

revoke insert on table "public"."user_referral_balances" from "authenticated";

revoke references on table "public"."user_referral_balances" from "authenticated";

revoke select on table "public"."user_referral_balances" from "authenticated";

revoke trigger on table "public"."user_referral_balances" from "authenticated";

revoke truncate on table "public"."user_referral_balances" from "authenticated";

revoke update on table "public"."user_referral_balances" from "authenticated";

revoke delete on table "public"."user_referral_balances" from "service_role";

revoke insert on table "public"."user_referral_balances" from "service_role";

revoke references on table "public"."user_referral_balances" from "service_role";

revoke select on table "public"."user_referral_balances" from "service_role";

revoke trigger on table "public"."user_referral_balances" from "service_role";

revoke truncate on table "public"."user_referral_balances" from "service_role";

revoke update on table "public"."user_referral_balances" from "service_role";

revoke delete on table "public"."user_token_balances" from "anon";

revoke insert on table "public"."user_token_balances" from "anon";

revoke references on table "public"."user_token_balances" from "anon";

revoke select on table "public"."user_token_balances" from "anon";

revoke trigger on table "public"."user_token_balances" from "anon";

revoke truncate on table "public"."user_token_balances" from "anon";

revoke update on table "public"."user_token_balances" from "anon";

revoke delete on table "public"."user_token_balances" from "authenticated";

revoke insert on table "public"."user_token_balances" from "authenticated";

revoke references on table "public"."user_token_balances" from "authenticated";

revoke select on table "public"."user_token_balances" from "authenticated";

revoke trigger on table "public"."user_token_balances" from "authenticated";

revoke truncate on table "public"."user_token_balances" from "authenticated";

revoke update on table "public"."user_token_balances" from "authenticated";

revoke delete on table "public"."user_token_balances" from "service_role";

revoke insert on table "public"."user_token_balances" from "service_role";

revoke references on table "public"."user_token_balances" from "service_role";

revoke select on table "public"."user_token_balances" from "service_role";

revoke trigger on table "public"."user_token_balances" from "service_role";

revoke truncate on table "public"."user_token_balances" from "service_role";

revoke update on table "public"."user_token_balances" from "service_role";
...
alter table "public"."chat_messages" drop constraint "chat_messages_room_id_fkey";

alter table "public"."couple_matches" drop constraint "couple_matches_couple1_id_couple2_id_key";

alter table "public"."couple_profiles" drop constraint "couple_profiles_communication_preference_check";

alter table "public"."couple_profiles" drop constraint "couple_profiles_interested_in_check";

alter table "public"."couple_profiles" drop constraint "couple_profiles_partner1_id_partner2_id_key";

alter table "public"."couple_profiles" drop constraint "couple_profiles_preferred_theme_check";

alter table "public"."couple_profiles" drop constraint "couple_profiles_profile_completeness_check";

alter table "public"."couple_profiles" drop constraint "couple_profiles_swinger_experience_check";

alter table "public"."couple_profiles" drop constraint "couple_profiles_verification_level_check";

alter table "public"."gallery_permissions" drop constraint "gallery_permissions_gallery_owner_id_fkey";

alter table "public"."gallery_permissions" drop constraint "gallery_permissions_status_check";

alter table "public"."invitation_statistics" drop constraint "invitation_statistics_user_id_fkey";

alter table "public"."invitations" drop constraint "invitations_from_profile_to_profile_key";

alter table "public"."matches" drop constraint "matches_match_score_check";
...
alter table "public"."referral_transactions" drop constraint "referral_transactions_token_type_check";

alter table "public"."reports" drop constraint "reports_report_type_check";

alter table "public"."token_transactions" drop constraint "token_transactions_related_user_id_fkey";

alter table "public"."two_factor_auth" drop constraint "two_factor_auth_user_id_key";

alter table "public"."user_token_balances" drop constraint "user_token_balances_cmpx_balance_check";

alter table "public"."user_token_balances" drop constraint "user_token_balances_gtk_balance_check";

alter table "public"."chat_members" drop constraint "chat_members_profile_id_fkey";
...
alter table "public"."couple_profile_reports" drop constraint "couple_profile_reports_status_check";

alter table "public"."gallery_permissions" drop constraint "gallery_permissions_permission_type_check";

alter table "public"."invitation_templates" drop constraint "invitation_templates_created_by_fkey";

alter table "public"."invitations" drop constraint "invitations_status_check";

alter table "public"."invitations" drop constraint "invitations_type_check";
...
alter table "public"."referral_statistics" drop constraint "referral_statistics_user_id_fkey";

alter table "public"."referral_transactions" drop constraint "referral_transactions_transaction_type_check";

alter table "public"."referral_transactions" drop constraint "referral_transactions_user_id_fkey";
...
alter table "public"."staking_records" drop constraint "staking_records_user_id_fkey";
...
alter table "public"."story_comments" drop constraint "story_comments_user_id_fkey";

alter table "public"."story_likes" drop constraint "story_likes_user_id_fkey";

alter table "public"."story_shares" drop constraint "story_shares_user_id_fkey";
...
alter table "public"."user_referral_balances" drop constraint "user_referral_balances_user_id_fkey";
...
drop function if exists "public"."generate_referral_code"(user_id uuid);

drop type "public"."geometry_dump";

drop function if exists "public"."sync_reports_content_type"();

drop function if exists "public"."update_chat_messages_updated_at"();

drop function if exists "public"."update_chat_rooms_updated_at"();

drop function if exists "public"."update_couple_profile_reports_updated_at"();

drop function if exists "public"."update_gallery_permissions_updated_at"();

drop function if exists "public"."update_invitation_templates_updated_at"();

drop function if exists "public"."update_invitations_updated_at"();

drop function if exists "public"."update_messages_updated_at"();

drop function if exists "public"."update_notifications_updated_at"();

drop function if exists "public"."update_referral_statistics_updated_at"();

drop function if exists "public"."update_reports_updated_at"();

drop function if exists "public"."update_staking_records_updated_at"();

drop function if exists "public"."update_stories_updated_at"();

drop function if exists "public"."update_two_factor_auth_updated_at"();

drop function if exists "public"."update_user_referral_balances_updated_at"();
...
alter table "public"."invitation_statistics" drop constraint "invitation_statistics_pkey";
...
drop index if exists "public"."idx_chat_members_room_id";

drop index if exists "public"."idx_chat_messages_conversation_id";

drop index if exists "public"."idx_chat_rooms_created_at";
...
drop index if exists "public"."idx_couple_profile_likes_liker";

drop index if exists "public"."idx_couple_profile_likes_profile";

drop index if exists "public"."idx_couple_profile_reports_profile";

drop index if exists "public"."idx_couple_profile_reports_reporter";

drop index if exists "public"."idx_couple_profile_views_profile";

drop index if exists "public"."idx_couple_profile_views_viewer";

drop index if exists "public"."idx_couple_profiles_active";

drop index if exists "public"."idx_couple_profiles_age_range";

drop index if exists "public"."idx_couple_profiles_experience_level";

drop index if exists "public"."idx_couple_profiles_interested_in";

drop index if exists "public"."idx_couple_profiles_is_public";

drop index if exists "public"."idx_couple_profiles_last_active";

drop index if exists "public"."idx_couple_profiles_location";

drop index if exists "public"."idx_couple_profiles_looking_for";

drop index if exists "public"."idx_couple_profiles_swinger_experience";

drop index if exists "public"."idx_couple_profiles_verified";

drop index if exists "public"."idx_gallery_permissions_gallery_owner_id";

drop index if exists "public"."idx_gallery_permissions_owner";

drop index if exists "public"."idx_gallery_permissions_status";

drop index if exists "public"."idx_invitation_statistics_period";

drop index if exists "public"."idx_invitation_statistics_user";

drop index if exists "public"."idx_invitation_templates_type";
...
drop index if exists "public"."idx_messages_room_id";

drop index if exists "public"."idx_messages_sender_id";

drop index if exists "public"."idx_notifications_created_at";

drop index if exists "public"."idx_notifications_group_key";
...
drop index if exists "public"."idx_reports_reported_user";
...
drop index if exists "public"."idx_token_analytics_created";

drop index if exists "public"."idx_token_transactions_type";

drop index if exists "public"."idx_user_token_balances_updated";

drop index if exists "public"."idx_user_token_balances_user";

drop index if exists "public"."invitation_statistics_pkey";

drop index if exists "public"."invitations_from_profile_to_profile_key";

drop index if exists "public"."profiles_email_key";

drop index if exists "public"."profiles_user_id_key";

drop index if exists "public"."two_factor_auth_user_id_key";

drop index if exists "public"."idx_chat_messages_created_at";

drop index if exists "public"."idx_couple_profile_likes_liked_at";

drop index if exists "public"."idx_couple_profile_reports_created_at";

drop index if exists "public"."idx_couple_profile_views_viewed_at";

drop index if exists "public"."idx_notifications_read";

drop index if exists "public"."idx_reports_created_at";

drop index if exists "public"."idx_token_analytics_period";
...
drop table "public"."invitation_statistics";
...
alter table "public"."chat_members" drop column "created_at";

alter table "public"."chat_members" drop column "is_admin";

alter table "public"."chat_members" drop column "is_muted";

alter table "public"."chat_members" drop column "last_read_at";

alter table "public"."chat_members" add column "role" text default 'member'::text;

alter table "public"."chat_members" alter column "profile_id" drop not null;

alter table "public"."chat_members" alter column "room_id" drop not null;

alter table "public"."chat_messages" drop column "conversation_id";

alter table "public"."chat_messages" drop column "is_read";

alter table "public"."chat_messages" drop column "location_address";

alter table "public"."chat_messages" drop column "location_latitude";

alter table "public"."chat_messages" drop column "location_longitude";

alter table "public"."chat_messages" drop column "read_at";

alter table "public"."chat_messages" alter column "sender_id" drop not null;

alter table "public"."chat_rooms" drop column "is_group";

alter table "public"."chat_rooms" drop column "room_type";
...
alter table "public"."couple_profile_likes" alter column "liked_at" set default now();

alter table "public"."couple_profile_likes" alter column "liked_at" drop not null;

alter table "public"."couple_profile_likes" alter column "liker_profile_id" set data type uuid using "liker_profile_id"::uuid;

alter table "public"."couple_profile_likes" enable row level security;

alter table "public"."couple_profile_reports" add column "resolution_notes" text;

alter table "public"."couple_profile_reports" add column "reviewed_at" timestamp with time zone;

alter table "public"."couple_profile_reports" add column "reviewed_by" uuid;

alter table "public"."couple_profile_reports" alter column "created_at" set default now();

alter table "public"."couple_profile_reports" alter column "created_at" drop not null;

alter table "public"."couple_profile_reports" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."couple_profile_reports" alter column "reason" set data type character varying(50) using "reason"::character varying(50);

alter table "public"."couple_profile_reports" alter column "reporter_profile_id" set data type uuid using "reporter_profile_id"::uuid;

alter table "public"."couple_profile_reports" alter column "status" set default 'pending'::character varying;

alter table "public"."couple_profile_reports" alter column "status" drop not null;

alter table "public"."couple_profile_reports" alter column "status" set data type character varying(20) using "status"::character varying(20);

alter table "public"."couple_profile_reports" alter column "updated_at" set default now();

alter table "public"."couple_profile_reports" alter column "updated_at" drop not null;

alter table "public"."couple_profile_reports" enable row level security;

alter table "public"."couple_profile_views" add column "viewed_date" date default CURRENT_DATE;

alter table "public"."couple_profile_views" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."couple_profile_views" alter column "viewed_at" set default now();

alter table "public"."couple_profile_views" alter column "viewed_at" drop not null;

alter table "public"."couple_profile_views" alter column "viewer_profile_id" set data type uuid using "viewer_profile_id"::uuid;

alter table "public"."couple_profile_views" enable row level security;

alter table "public"."couple_profiles" drop column "activities_interested";

alter table "public"."couple_profiles" drop column "age_range_max";

alter table "public"."couple_profiles" drop column "age_range_min";

alter table "public"."couple_profiles" drop column "city";

alter table "public"."couple_profiles" drop column "communication_preference";

alter table "public"."couple_profiles" drop column "compatibility_factors";

alter table "public"."couple_profiles" drop column "country";

alter table "public"."couple_profiles" drop column "couple_age_range";

alter table "public"."couple_profiles" drop column "couple_availability";

alter table "public"."couple_profiles" drop column "couple_body_type";

alter table "public"."couple_profiles" drop column "couple_height_range";

alter table "public"."couple_profiles" drop column "couple_interests";

alter table "public"."couple_profiles" drop column "couple_lifestyle";

alter table "public"."couple_profiles" drop column "display_name";

alter table "public"."couple_profiles" drop column "event_types";

alter table "public"."couple_profiles" drop column "experience_level";

alter table "public"."couple_profiles" drop column "interested_in";

alter table "public"."couple_profiles" drop column "is_active";

alter table "public"."couple_profiles" drop column "is_demo";

alter table "public"."couple_profiles" drop column "is_public";

alter table "public"."couple_profiles" drop column "last_active";
...
alter table "public"."couple_profiles" drop column "max_distance";

alter table "public"."couple_profiles" drop column "preferences";

alter table "public"."couple_profiles" drop column "preferred_theme";

alter table "public"."couple_profiles" drop column "privacy_settings";

alter table "public"."couple_profiles" drop column "profile_completed_at";

alter table "public"."couple_profiles" drop column "profile_completeness";

alter table "public"."couple_profiles" drop column "relationship_duration";

alter table "public"."couple_profiles" drop column "state";

alter table "public"."couple_profiles" drop column "statistics";

alter table "public"."couple_profiles" drop column "swinger_experience";

alter table "public"."couple_profiles" drop column "total_likes";

alter table "public"."couple_profiles" drop column "total_matches";

alter table "public"."couple_profiles" drop column "total_views";

alter table "public"."couple_profiles" drop column "verification_level";
...
alter table "public"."gallery_permissions" drop column "expires_at";

alter table "public"."gallery_permissions" drop column "gallery_owner_id";

alter table "public"."gallery_permissions" drop column "status";

alter table "public"."gallery_permissions" drop column "updated_at";

alter table "public"."gallery_permissions" add column "profile_id" uuid;
...
alter table "public"."gallery_permissions" alter column "permission_type" set default 'view'::text;

alter table "public"."gallery_permissions" alter column "permission_type" drop not null;

alter table "public"."invitation_templates" drop column "content";

alter table "public"."invitation_templates" drop column "name";

alter table "public"."invitation_templates" drop column "template_type";

alter table "public"."invitation_templates" drop column "type";
...
alter table "public"."invitation_templates" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."invitation_templates" alter column "invitation_type" drop default;
...
alter table "public"."invitations" alter column "created_at" drop not null;

alter table "public"."invitations" alter column "from_profile" drop not null;

alter table "public"."invitations" alter column "from_profile" set data type uuid using "from_profile"::uuid;

alter table "public"."invitations" alter column "to_profile" drop not null;

alter table "public"."invitations" alter column "to_profile" set data type uuid using "to_profile"::uuid;

alter table "public"."invitations" alter column "type" set default 'connection'::text;

alter table "public"."invitations" enable row level security;

alter table "public"."matches" drop column "match_score";
...
alter table "public"."matches" alter column "created_at" drop not null;

alter table "public"."matches" alter column "updated_at" set default now();

alter table "public"."matches" alter column "updated_at" drop not null;

alter table "public"."matches" alter column "user1_id" drop not null;

alter table "public"."matches" alter column "user1_id" set data type uuid using "user1_id"::uuid;

alter table "public"."matches" alter column "user2_id" drop not null;

alter table "public"."matches" alter column "user2_id" set data type uuid using "user2_id"::uuid;

alter table "public"."matches" enable row level security;

alter table "public"."messages" drop column "conversation_id";

alter table "public"."messages" drop column "location_address";

alter table "public"."messages" drop column "location_latitude";

alter table "public"."messages" drop column "location_longitude";

alter table "public"."messages" alter column "sender_id" drop not null;

alter table "public"."notifications" drop column "action_url";

alter table "public"."notifications" drop column "expires_at";

alter table "public"."notifications" drop column "group_key";

alter table "public"."notifications" drop column "priority";

alter table "public"."notifications" drop column "read";

alter table "public"."notifications" drop column "scheduled_for";

alter table "public"."notifications" drop column "sender_id";

alter table "public"."notifications" drop column "sender_name";
...
alter table "public"."notifications" alter column "user_id" set data type uuid using "user_id"::uuid;
...
alter table "public"."referral_statistics" drop column "active_referrals";

alter table "public"."referral_statistics" drop column "total_referrals";
...
alter table "public"."referral_statistics" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."referral_statistics" alter column "monthly_earned" set not null;

alter table "public"."referral_statistics" alter column "monthly_earned" set data type bigint using "monthly_earned"::bigint;

alter table "public"."referral_statistics" alter column "period_end" set default (CURRENT_DATE + '1 mon'::interval);

alter table "public"."referral_statistics" alter column "period_end" set not null;

alter table "public"."referral_statistics" alter column "period_end" set data type date using "period_end"::date;

alter table "public"."referral_statistics" alter column "period_start" set default CURRENT_DATE;

alter table "public"."referral_statistics" alter column "period_start" set not null;

alter table "public"."referral_statistics" alter column "period_start" set data type date using "period_start"::date;

alter table "public"."referral_statistics" alter column "referral_code" set data type character varying(20) using "referral_code"::character varying(20);

alter table "public"."referral_statistics" alter column "total_earned" set not null;

alter table "public"."referral_statistics" alter column "total_earned" set data type bigint using "total_earned"::bigint;

alter table "public"."referral_transactions" drop column "token_type";

alter table "public"."referral_transactions" add column "balance_after" bigint not null;

alter table "public"."referral_transactions" add column "balance_before" bigint not null;
...
alter table "public"."referral_transactions" alter column "description" drop not null;

alter table "public"."referral_transactions" alter column "id" set default extensions.uuid_generate_v4();
...
alter table "public"."reports" drop column "report_type";
...
alter table "public"."reports" add column "reviewed_at" timestamp with time zone;

alter table "public"."reports" add column "reviewed_by" uuid;

alter table "public"."reports" alter column "content_type" set not null;

alter table "public"."reports" alter column "created_at" set default now();

alter table "public"."reports" alter column "reported_content_id" set not null;

alter table "public"."reports" alter column "reported_content_id" set data type uuid using "reported_content_id"::uuid;

alter table "public"."reports" alter column "reported_user_id" set not null;

alter table "public"."reports" alter column "reported_user_id" set data type uuid using "reported_user_id"::uuid;

alter table "public"."reports" alter column "reporter_user_id" set data type uuid using "reporter_user_id"::uuid;

alter table "public"."reports" alter column "status" drop not null;
...
alter table "public"."staking_records" add column "apy" numeric(5,2) not null default 0.00;
...
alter table "public"."staking_records" alter column "end_date" drop not null;

alter table "public"."staking_records" alter column "id" set default extensions.uuid_generate_v4();
...
alter table "public"."staking_records" alter column "token_type" drop default;
...
alter table "public"."stories" drop column "content_url";

alter table "public"."stories" drop column "expires_at";

alter table "public"."stories" drop column "location";

alter table "public"."stories" drop column "media_urls";
...
alter table "public"."stories" add column "media_url" text;
...
alter table "public"."story_comments" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."story_likes" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."story_shares" add column "platform" character varying(50);

alter table "public"."story_shares" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."story_shares" alter column "share_type" drop default;

alter table "public"."story_shares" alter column "share_type" set not null;

alter table "public"."story_shares" alter column "share_type" set data type character varying(20) using "share_type"::character varying(20);

alter table "public"."token_analytics" drop column "updated_at";

alter table "public"."token_analytics" alter column "active_stakers" set not null;

alter table "public"."token_analytics" alter column "circulating_cmpx" set not null;

alter table "public"."token_analytics" alter column "circulating_gtk" set not null;
...
alter table "public"."token_analytics" alter column "total_cmpx_supply" set not null;

alter table "public"."token_analytics" alter column "total_gtk_supply" set default 0;

alter table "public"."token_analytics" alter column "total_gtk_supply" set not null;
...
alter table "public"."token_transactions" drop column "balance_before";

alter table "public"."token_transactions" drop column "description";

alter table "public"."token_transactions" drop column "related_user_id";
...
alter table "public"."token_transactions" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."token_transactions" alter column "metadata" set default '{}'::jsonb;

alter table "public"."token_transactions" alter column "token_type" drop default;
...
alter table "public"."two_factor_auth" alter column "method" drop default;
...
alter table "public"."user_referral_balances" drop column "gtk_balance";

alter table "public"."user_referral_balances" add column "last_reset_date" date not null default CURRENT_DATE;
...
alter table "public"."user_referral_balances" alter column "id" set default extensions.uuid_generate_v4();
...
alter table "public"."user_referral_balances" alter column "referral_code" set data type character varying(20) using "referral_code"::character varying(20);
...
alter table "public"."user_token_balances" drop column "last_updated";

alter table "public"."user_token_balances" drop column "total_earned_cmpx";

alter table "public"."user_token_balances" drop column "total_earned_gtk";
...
alter table "public"."user_token_balances" alter column "id" set default extensions.uuid_generate_v4();
...
CREATE TRIGGER update_couple_profiles_updated_at BEFORE UPDATE ON public.couple_profiles FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();


CREATE TRIGGER create_user_tokens_trigger AFTER INSERT ON auth.users FOR EACH ROW EXECUTE FUNCTION create_user_tokens();

CREATE TRIGGER trigger_create_user_tokens AFTER INSERT ON auth.users FOR EACH ROW EXECUTE FUNCTION create_user_tokens();
