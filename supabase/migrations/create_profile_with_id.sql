-- Script corregido para crear perfil con campo 'id' requerido
...
-- 2. Crear perfil con campo 'id' generado automáticamente
INSERT INTO public.profiles (
    ...
    gen_random_uuid(),  -- Generar UUID para el campo 'id'
