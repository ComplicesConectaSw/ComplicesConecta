-- Script básico para aplicar migraciones en Supabase
-- ComplicesConecta v3.4.0 - Solo crea tablas básicas
...
-- =====================================================
-- ÍNDICES BÁSICOS (SOLO LOS QUE FUNCIONAN)
-- =====================================================

-- Índices para optimizar consultas (solo los básicos)
...
SELECT 'Migraciones básicas aplicadas exitosamente - ComplicesConecta v3.4.0' as status;
