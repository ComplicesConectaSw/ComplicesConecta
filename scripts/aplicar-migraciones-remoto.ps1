...
# Nota 26-Nov-2025: Esta salida complementa el flujo oficial `supabase db push`/`supabase db reset`
# usando Supabase CLI. Solo genera el bloque SQL para entornos donde no se pueda
# correr la CLI (p.ej. Dashboard remoto).
...
$migrationsToApply = @(
    "20251126_create_global_search.sql" # pg_trgm + search_unified RPC para FloatingNav/GlobalSearchService
)
