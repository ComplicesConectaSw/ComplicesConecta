-- =====================================================
-- SCRIPT: Migraciones Seguras - Sin Columnas Inexistentes
-- Fecha: 14/09/2025 10:45hrs
-- Versión: v2.8.2 - Solo Tablas Nuevas
-- =====================================================

-- PASO 1: Crear tabla couple_photos (sin referencias problemáticas)
-- =====================================================
...
-- Políticas RLS básicas (sin referencias a columnas inexistentes)
...
-- PASO 2: Crear tablas de chat básicas
-- =====================================================
...
-- Políticas RLS básicas para chat (simplificadas)
...
SELECT 
    ...
    CASE WHEN EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'chat_typing') 
         THEN 'CREADA ✅' 
         ELSE 'ERROR ❌' 
    END as status;
