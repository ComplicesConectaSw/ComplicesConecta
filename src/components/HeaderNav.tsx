          ...
          <div className="flex items-center space-x-1 sm:space-x-2 flex-shrink-0">
            {userIsAuthenticated ? (
              ...
              <Button
                ...
                className="border-white/30 text-white hover:bg-white/20 px-2 sm:px-3 py-1.5 whitespace-nowrap text-xs font-medium bg-white/10 transition-all duration-200 shadow-md hover:shadow-lg min-w-fit flex-shrink-0"
              >
