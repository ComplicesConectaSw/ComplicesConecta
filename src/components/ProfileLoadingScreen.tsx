    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-hero-gradient">
      ...
      <div className="relative z-10 text-center space-y-8 px-6">
        ...
        <div className="space-y-4">
          <h2 className="text-4xl font-bold text-white animate-fade-in bg-gradient-to-r from-white to-pink-200 bg-clip-text text-transparent">
            {profileName}
          </h2>
          ...
          <p className="text-lg text-white/90 animate-slide-up max-w-md mx-auto">
        ...
        <div className="absolute top-1/4 right-24 animate-float" style={{ animationDelay: '3s' }}>
          <Star className="w-4 h-4 text-yellow-300/70" />
        </div>
        <div className="absolute bottom-1/4 left-24 animate-float" style={{ animationDelay: '2s' }}>
