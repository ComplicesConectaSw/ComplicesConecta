...
const Settings = () => {
  ...
  const swingerFeatures = [
    {
      icon: Shield,
      title: "Verificaci�n Lifestyle KYC",
      description: "Verificaci�n de identidad + validaci�n de experiencia swinger para comunidad aut�ntica",
      status: "Activo"
    },
    {
      icon: MessageSquare,
      title: "Chat �ntimo Encriptado",
      description: "Conversaciones privadas entre parejas con encriptaci�n militar para m�xima discreci�n",
      status: "Activo"
    },
    {
      icon: MapPin,
      title: "Encuentros Gelocalizados",
      description: "Localiza parejas swinger y clubs exclusivos cerca de tu ubicaci�n",
      status: "Activo"
    },
    {
      icon: Calendar,
        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Gestiona tu experiencia swinger: conexiones, eventos privados y estad�sticas de tu vida �ntima
            </p>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {swingerFeatures.map((feature, index) => (
                    <Card 
                      ...
                      onClick={() => {
                        if (feature.title === "Verificaci�n Lifestyle KYC") {
          ...
          <Card className="bg-hero-gradient border-0 text-white">
            ...
            <CardContent className="text-center space-y-6">
              <p className="text-white/90 text-lg max-w-2xl mx-auto">
                ...
                y experiencias �ntimas que transformar�n tu vida sexual.
              </p>
