  ...
  const allProfiles = [
    {
      ...
      age: 28,
      location: "Tu Ciudad",
      interests: ["Lifestyle Swinger", "Mentalidad Abierta", "Comunicación Abierta", "Experiencias Nuevas", "Respeto Mutuo", "Ambiente Relajado"],
      image: "https://images.unsplash.com/photo-1494790108755-2616b332c1c0?w=400&h=600&fit=crop&crop=face",
      rating: 4.8,
      isOnline: true,
      bio: "Mujer soltera explorando el lifestyle swinger con mentalidad abierta. Busco conexiones auténticas y experiencias nuevas en un ambiente de respeto mutuo y discreción total.",
