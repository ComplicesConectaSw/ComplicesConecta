    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-pink-900 to-red-900 relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="max-w-4xl mx-auto p-6 space-y-8">
          ...
          <Card className="bg-white/10 backdrop-blur-md border-white/20 shadow-2xl">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-xl text-white/90 font-medium leading-relaxed mb-6">
                La plataforma social l�der en M�xico para adultos que buscan conexiones aut�nticas 
              ...
              <div className="grid md:grid-cols-3 gap-4 mt-6">
                ...
                <div className="bg-white/5 rounded-lg p-4">
                  ...
                  <p className="text-white/70 text-xs">Verificaci�n de identidad obligatoria</p>
                </div>
                <div className="bg-white/5 rounded-lg p-4">
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-white">Nuestra Misi�n</h3>
                </div>
                <p className="text-white font-medium leading-relaxed">
                  Crear un espacio seguro donde parejas y solteros del lifestyle swinger puedan 
                  conectar de manera aut�ntica, explorando nuevas experiencias con total 
                  discreci�n y respeto mutuo.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-white">Nuestra Visi�n</h3>
                </div>
                <p className="text-white font-medium leading-relaxed">
                  Convertirnos en una plataforma confiable para la comunidad lifestyle en M�xico, 
                  reconocida por brindar un ambiente seguro, tecnolog�a moderna y compromiso 
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center group">
                  ...
                  <p className="text-white/70 text-sm">
                    Sistema de verificaci�n de usuarios y protecci�n de datos personales.
                  </p>
                </div>
                ...
                <div className="text-center group">
                  ...
                  <p className="text-white/70 text-sm">
                    Comunidad lifestyle con c�digos de respeto y �tica bien definidos.
                  </p>
                </div>
                ...
                <div className="text-center group">
                  ...
                  <h4 className="text-lg font-semibold text-white mb-2">Innovaci�n</h4>
                  <p className="text-white/70 text-sm">
            ...
            <CardContent className="p-8">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-colors">
                  ...
                  <h4 className="font-semibold text-white mb-2">Historias Ef�meras</h4>
                ...
                <div className="bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-colors">
                  ...
                  <p className="text-white/70 text-sm">Algoritmo avanzado que conecta seg�n compatibilidad y preferencias</p>
                </div>
                <div className="bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-colors">
                  <Shield className="h-8 w-8 text-green-400 mb-3" />
                  <h4 className="font-semibold text-white mb-2">Verificaci�n Biom�trica</h4>
                  <p className="text-white/70 text-sm">Sistema 2FA con autenticaci�n facial y huella digital</p>
                </div>
                <div className="bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-colors">
                  <Eye className="h-8 w-8 text-pink-400 mb-3" />
                  <h4 className="font-semibold text-white mb-2">Galer�as NFT-Verificadas</h4>
                  <p className="text-white/70 text-sm">Perfiles y galer�as como NFTs mintados con GTK tokens</p>
                </div>
                <div className="bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-colors">
                  ...
                  <p className="text-white/70 text-sm">Detecci�n proactiva de consentimiento en chats con IA</p>
                </div>
                <div className="bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-colors">
          ...
          <Card className="bg-white/10 backdrop-blur-md border-white/20 shadow-xl">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-white mb-6 text-center">Nuestra Comunidad en N�meros</h3>
              <div className="grid md:grid-cols-4 gap-6 text-center">
                <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg p-6">
                  ...
                  <div className="text-white/70 text-sm">Versi�n Actual</div>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-white">Encriptaci�n AES-GCM</h4>
                      <p className="text-white/70 text-sm">Todos los datos est�n protegidos con cifrado militar de grado empresarial</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">Certificados en protecci�n de datos europea y mexicana</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Eye className="h-6 w-6 text-blue-400 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-white">Moderaci�n IA + Humana</h4>
                      <p className="text-white/70 text-sm">Sistema h�brido de detecci�n de contenido inapropiado</p>
                    </div>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-white">Verificaci�n Obligatoria</h4>
                      <p className="text-white/70 text-sm">Documento oficial + selfie + verificaci�n telef�nica</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Zap className="h-6 w-6 text-orange-400 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-white">Detecci�n de Fraude</h4>
          ...
          <Card className="bg-gradient-to-r from-pink-500/20 to-purple-600/20 backdrop-blur-md border-pink-300/30 shadow-xl">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-white font-medium mb-6">
                �nete a nuestra creciente comunidad lifestyle en M�xico. 
