              ...
              <div className="space-y-4">
                <div className="bg-white/5 rounded-lg p-4">
                  ...
                  <ul className="text-white/70 text-sm space-y-2 text-left">
                    <li>� Revisaremos tu solicitud en 2-3 d�as h�biles</li>
                    <li>� Te contactaremos por email con la decisi�n</li>
                    <li>� Si eres aprobado, recibir�s un enlace de activaci�n</li>
                    <li>� Podr�s acceder al panel de moderaci�n una vez activado</li>
                  </ul>
                </div>
                <Link to="/">
      ...
      <div className="max-w-2xl mx-auto p-6 pt-24">
        <div className="mb-8">
          ...
          <p className="text-white/80">
            �nete a nuestro equipo de moderaci�n y ayuda a mantener la comunidad segura
          </p>
        </div>
        ...
        <Card className="bg-white/10 backdrop-blur-sm border-white/20 mb-6">
          <CardHeader>
            ...
            <CardDescription className="text-white/80">
              �nete a nuestro equipo de moderaci�n y ayuda a crear un espacio seguro y respetuoso para todos
            </CardDescription>
          </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white/5 rounded-lg p-4">
                ...
                <ul className="text-white/70 text-sm space-y-2">
                  ...
                  <li>� <strong>Apoyo a usuarios:</strong> Resolver consultas sobre pol�ticas de la comunidad</li>
                  <li>� <strong>Prevenci�n:</strong> Identificar patrones de comportamiento problem�tico</li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 rounded-lg p-4">
                ...
                <ul className="text-white/70 text-sm space-y-2">
                  <li>� <strong>Edad:</strong> Mayor de 21 a�os (preferible)</li>
                  <li>� <strong>Disponibilidad:</strong> M�nimo 8-10 horas semanales</li>
                  <li>� <strong>Experiencia:</strong> Moderaci�n online, atenci�n al cliente o psicolog�a</li>
                  <li>� <strong>Habilidades:</strong> Comunicaci�n emp�tica y toma de decisiones</li>
                  <li>� <strong>Compromiso:</strong> M�nimo 6 meses en el programa</li>
                </ul>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="w-full p-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50"
                    placeholder="Describe tu experiencia en moderaci�n, administraci�n de comunidades, atenci�n al cliente, etc."
                    rows={3}
                  />
                </div>
                ...
                <div>
                  <label className="text-white text-sm mb-2 block">
                    Experiencia Previa en Moderaci�n
                  </label>
                  <textarea
