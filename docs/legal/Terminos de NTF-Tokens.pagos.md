# Términos de Servicio - CompliciesConecta v3.7.0

**Fecha:** 08 Nov 2025  
**Alcance:** NFTs, Tokens, Staking, +18.
...
1. **Mint:** Gratis o 100 CMPX.
2. **Venta:** 5% fee app.
3. **Staking:** 10% APY CMPX.
4. **Pareja:** Consentimiento doble obligatorio.
5. **Revocación:** 72h "derecho al olvido".
...
\- \*\*Mint:\*\* Gratis o 100 CMPX.

\- \*\*Comisiones:\*\* 90% creador, 5% app, 5% dev.

\- \*\*Gas:\*\* Cubierto por app (testnet) o CMPX (mainnet).
